...
mkdir -p hinitoutput
#-m 1, minum segmen 1
cmd="$HTKTOOLSDIR/HInit  -C configtrain.txt -T 20  -m 1 -M hinitoutput VOI arctic_a0001.mfc"
echo $cmd ; eval $cmd
cmd="$HTKTOOLSDIR/HInit  -C configtrain.txt -T 20  -m 1 -M hinitoutput UNV arctic_a0001.mfc"
echo $cmd ; eval $cmd
